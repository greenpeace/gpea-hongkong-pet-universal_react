        ...
        <Box flex="1">
          ...
          <Box p={{ base: 4, sm: 10 }} mt="4">
            <Stack pb={4}>
              ...
              <Box>
              <Text as="h1" fontSize={{ base: "2xl", sm: "3xl", xl: "4xl" }} mt="2" color="gray.900" lineHeight={{base: "30px", sm: "36px"}}>
                「與生態專家探索香港『野』」網上教室
              </Text>
              </Box>
            </Stack>
            ...
            <Box>
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8}>
                <Stack>
                  <Flex {...flexBoxStyle}>
                    <Image
                      src={`${process.env.PUBLIC_URL}/events/biodiversity/Pic1.png`}
                      borderRadius="8px"
                    />
                  </Flex>
                </Stack>
                <Stack>
                  <Flex {...flexBoxStyle}>
                    <Image
                      src={`${process.env.PUBLIC_URL}/events/biodiversity/Pic3.png`}
                      borderRadius="8px"
                    />
                  </Flex>
                </Stack>
          ...
          <Flex justifyContent="space-between" direction={{base: 'column'}}>            
            <Box>
              <Flex direction={{base: 'column', xl: 'row'}}>
                <Box maxW={{base: "100%"}}>
                  <Image src={`${process.env.PUBLIC_URL}/events/biodiversity/ma_solo.jpg`} borderRadius="8px" w="100%"/>
                </Box>
                <Box align="center">
                  <Center h="100%">
                  <Box bgColor="#FFF" borderRadius="8px" p={6} ml={{base: '0px', xl: '-110px'}} mt={{base: '-80px', xl: '0px'}} w={{base: "230px"}}>
                    <Box
                      maxW="120px"
                      ...
                      mb="6"
                    >
                      <Image src={`${process.env.PUBLIC_URL}/events/biodiversity/ma_2x.png`}/>
                    </Box>
                    <Heading
                  ...
                  <Text size="sm" color="gray.500">自然教育家</Text>
                  </Box>
                  </Center>
                </Box>
              </Flex>
            ...
            <Text {...pStyle} mt={8} pr={{base: 0, xl: "30px"}}>
              香港少數本地環境教育及生態研究學者、香港戶外生態教育協會創辦人及教育總監，同時為國際樹木學會註冊樹藝師。Dr. Xoni Ma曾參與多項本地植物調查及森林群落研究，以及生物多樣性教育項目，主講講座如《香港林地與植被》等。多年來，Dr. Xoni Ma  亦熱心推動本港的環境教育，參與設計多套學科和環境教育戶外考察教材，亦曾多次帶領教師培訓和學生考察活動，包括到訪肯亞、坦桑尼亞及馬達加斯加。
            </Text>
            </Center>
            ...
            <Box>
              <Flex direction={{base: 'column', xl: 'row'}}>
                ...
                <Box align="center">
                  ...
                  <Text size="sm" color="gray.500">本地生態攝影師</Text>
                  </Box>
                  </Center>
                </Box>
              </Flex>
            ...
            <Box flex="1" px={{base: 0}}>
              <Center h="100%">
                <Text {...pStyle} mt={8} pr={{base: 0, xl: "15px"}}>
                  生態攝影師、《Wild Hong Kong》系列生態紀錄片製作人，該系列被譽為「港版Discovery Channel」，他亦曾拍攝與編導香港電台本地生態紀錄片節目《大自然大不同》第二季單元。阿城鏡頭下的野生動物包括灰背燕尾、香港鬥魚、和尚蟹等等，向大眾呈現各類物種的習性、捕食過程等。阿城希望用影像的力量，重新聯繫人類與大自然，紀錄動物們活著的美好一面。
                </Text>
              </Center>       
            </Box>
