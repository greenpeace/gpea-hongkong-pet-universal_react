...
const Landing = ({ submitted, togglePanel }) => {
  ...
  const thumbnailContent = [
    {thumbnail: thumbnail, content: '綠色和平團隊駕駛橡皮艇靠近巨大的採礦機器，舉起橫額與畫上「RISK」字眼抗議。'},
    {thumbnail: thumbnailTwo, content: 'Kelly在航程中遇見野生海豚、吞拿魚、極度瀕危的欖蠵龜等海洋生物。'},
    {thumbnail: thumbnailThree, content: 'Kelly與團隊24小時站崗，觀察採礦機器的一舉一動，揭露企業污染海洋的真相。'}
  ]
            ...
            <Box pb={12}>
              ...
              <SimpleGrid mt="4" columns={{ base: 1, xl: 2 }} spacing={10}>
                ...
                <Stack spacing={4}>
                  ...
                  <Text {...pStyle}>
                  此刻，全球公海只有約1%受保護，要有效管制破壞海洋的行為，以保護、維持、復育海洋。<br/>綠色和平急需您的支持，在今年爭取訂立「全球海洋公約」，大步邁向擴展全球海洋保護區至30%的目標。
                  </Text>
                  <Link
