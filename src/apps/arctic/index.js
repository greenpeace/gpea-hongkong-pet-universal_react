      ...
      <Flex>
        <Box flex="1" bgColor="campaign.arctic" px={20}>
            ...
            <Center h="100%">
              ...
              <Box >
                <Center h="100%">
                  <Heading fontSize="140px" lineHeight="160px" letterSpacing="-4px" pos="absolute" color="#FFF">救氣候<br/>阻止北極破壞！</Heading>
                  <Box>
                      <Image
                        src={
                          "/custom/images/a_pic.jpg"
                        }
                      />
                  </Box>
                </Center>
            ...
            <Box mb={10}>
              ...
              <Box flex="1" bgColor="#0E5A62" color="#FFF" p={4}>
                <Center p={10}>
                    <VStack>
                    <Heading mb={0} alignSelf="self-start">密切跟進！北極漏油事故</Heading>
                    <Box fontSize={18} my={6}>
                      <Text as="p">氣候危機加劇，高溫令永久凍土融化，增加漏油風險，嚴重威脅北極生態！</Text>
                      <Text as="p">2020年5月29日，俄羅斯爆發2萬噸柴油洩漏事故，綠色和平到訪現場追查真相，過程被當局處處阻撓，令水土樣本無法運送至實驗室。</Text>
                      <Text as="p">我們必須追究企業責任，否則類似事故將有增無減！</Text>
                    </Box>
                    </VStack>
                  </Center>
                </Box>
