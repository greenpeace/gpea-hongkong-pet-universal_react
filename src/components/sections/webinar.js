...
const Webinar = ({ content }) => {
  ...
  return (
    <Box>
      ...
      <Stack spacing={4}>
        <Feature
          icon={<Icon as={BiCalendar} color={"brand.400"} w={5} h={5} />}
          iconBg={useColorModeValue("brand.100", "brand.900")}
          text={content.date}
        />
        <Feature
          icon={<Icon as={IoTimeSharp} color={"#FFF"} w={5} h={5} />}
          iconBg={"brand.300"}
          text={content.time}
        />
        <Feature
          icon={<Icon as={SiAirplayvideo} color={"#FFF"} w={5} h={5} />}
          iconBg={"green.900"}
          text={content.description}
        />
        {content.other && (
          <Feature
            icon={<Icon as={GoBook} color={"#FFF"} w={5} h={5} />}
            iconBg={"gray.500"}
            text={content.other}
          />
        )}
